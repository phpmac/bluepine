                        ...
                        <div className="flex flex-col gap-4 rounded-2xl border border-white/10 bg-white/7 px-5 py-4">
                            <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-xs tracking-[0.3em] text-slate-300/75 uppercase">{t('vesting.rhythm.title')}</p>
                                        <p className="text-sm font-semibold text-white">{t('vesting.rhythm.detail')}</p>
                                    </div>
                                </div>
