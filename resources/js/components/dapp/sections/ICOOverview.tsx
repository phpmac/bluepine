        ...
        const handleBuy = async () => {
            ...
            if (!usdtAllowance || usdtAllowance < usdtRequired) {
                writeApprove({
                    ...
                    args: [address.buy as `0x${string}`, usdtRequired], // 授权10倍额度
                });
                return; // 授权成功后会自动触发购买
            }
                            ...
                            <div className="relative flex-1 overflow-hidden rounded-[32px] border border-white/12 bg-linear-to-br from-[#0e182f] via-[#071122] to-[#040b18] p-8 shadow-[0_30px_90px_-45px_rgba(60,110,255,0.68)]">
                                ...
                                <div id="token-purchase-form" className="relative z-10 flex flex-col gap-5">
                                    ...
                                    <motion.button
                                        ...
                                        className={`w-full rounded-xl px-5 py-3 text-sm font-semibold transition-all duration-300 ${!isConnected || !isValidAescAmount || !isValidReferrerAddress
                                    ...
                                    <div className="rounded-xl border border-[#22edc7]/20 bg-[#22edc7]/5 p-3">
                                        ...
                                        <motion.button
                                            ...
                                            className={`w-full rounded-lg border px-4 py-2 text-sm font-semibold transition-all duration-300 ${!isConnected ||
                                                    !isEnded ||
                                                    (getUserClaimableAmount[0] <= 0 && getUserClaimableAmount[1] <= 0) ||
                                                    isClaiming ||
                                                    isClaimConfirming
