            ...
            >
                ...
                <div className="absolute inset-0">
                    ...
                    <div className="gift-box-container absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                        ...
                        <div className="gift-box-base relative h-40 w-40">
                            <div className="absolute inset-0 rounded-lg bg-linear-to-br from-emerald-400 via-emerald-500 to-teal-600 shadow-2xl">
                                {/* 丝带装饰 */}
                        ...
                        <div className="gift-box-lid absolute left-1/2 -translate-x-1/2" style={{ top: '-20px', transformOrigin: 'bottom center' }}>
                            <div className="h-20 w-44 rounded-lg bg-linear-to-br from-emerald-500 via-emerald-600 to-teal-600 shadow-xl">
                        ...
                        <div className="flying-icon" style={{ animationDelay: '0.5s' }}>
                            <div className="flex h-16 w-16 items-center justify-center rounded-lg bg-linear-to-br from-emerald-400 to-teal-600 shadow-lg">
                        ...
                        <div className="flying-icon" style={{ animationDelay: '0.7s' }}>
                            <div className="flex h-14 w-14 items-center justify-center rounded-full bg-linear-to-br from-teal-400 to-cyan-600 shadow-lg">
                        ...
                        <div className="flying-icon" style={{ animationDelay: '0.9s' }}>
                            <div className="flex h-14 w-14 items-center justify-center rounded-full bg-linear-to-br from-emerald-400 to-green-600 shadow-lg">
                                <svg className="h-7 w-7 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                        ...
                        <div className="flying-icon" style={{ animationDelay: '1.1s' }}>
                            <div className="flex h-14 w-14 items-center justify-center rounded-full bg-linear-to-br from-cyan-400 to-teal-600 shadow-lg">
                                <svg className="h-7 w-7 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                    ...
                    {/* 渐变遮罩 */}
                    <div className="absolute inset-0 bg-linear-to-b from-transparent via-black/30 to-black/60"></div>
                </div>
                ...
                <div className="relative z-10 mx-auto w-full max-w-7xl py-20">
                    <div className="text-center">
                        ...
                        {/* 核心行动按钮 */}
                        <a
                            href={!hasStarted ? '#participate' : 'https://app.galxe.com/quest/nXMwfnLRpfEetotHQmySjM/GCL9Jt8kbz'}
