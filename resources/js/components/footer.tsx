export function Footer() {
    const footerLinks = {
        产品: ['生态系统', '技术架构', '智能合约', 'API 文档'],
        资源: ['白皮书', '开发文档', '社区论坛', '博客'],
        公司: ['关于我们', '团队介绍', '加入我们', '联系我们'],
        法律: ['隐私政策', '服务条款', '合规声明', 'Cookie 政策'],
    };
            ...
            <div className="container mx-auto px-4 py-16 sm:px-6 lg:px-8">
                <div className="mb-12 grid gap-12 md:grid-cols-2 lg:grid-cols-5">
                    <div className="lg:col-span-1">
                        ...
                        <p className="text-sm leading-relaxed text-slate-400">全球领先的农业+区块链+AI生态构建者</p>
                    </div>

                    {Object.entries(footerLinks).map(([category, links]) => (
                        <div key={category}>
                            <h3 className="mb-4 font-semibold text-slate-100">{category}</h3>
                ...
                <div className="flex flex-col items-center justify-between gap-4 border-t border-slate-800 pt-8 md:flex-row">
                    <p className="text-sm text-slate-400">© 2025 BLUEPINE Tech Foundation. 保留所有权利.</p>
